...
export default clerkMiddleware(async (auth, req) => {
  ...
  // Un compte connecté sans le rôle admin est renvoyé à l'accueil (401 pour les
  // routes API, qui ne suivent pas de redirection). Les pages et server actions
  // revérifient de leur côté via `requireAdmin`.
